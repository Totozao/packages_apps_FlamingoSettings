...
class AppLockPackageProtectionPC(
    ...
    override fun setChecked(checked: Boolean): Boolean {
        android.util.Log.d("GAY", "setChecked: checked = $checked")
        isProtected = checked
        coroutineScope.launch(Dispatchers.Default) {
            android.util.Log.d("GAY", "inside coroutine")
            if (isProtected) {
    ...
    override fun displayPreference(screen: PreferenceScreen) {
        ...
        android.util.Log.d("GAY", "preference = $preference")
    }
}